...
para(46,158,'First record every suspect’s whereabouts and connection to Vikram. Then recall Devraj: only the reports you requested become available. Present each exhibit separately. Unrequested reports remain sealed.',size=10)
